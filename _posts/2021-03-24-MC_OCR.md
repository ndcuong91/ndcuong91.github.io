---
layout: post
title: Trích xuất thông tin quan trọng từ hóa đơn bằng Graph Convolutional Network (GCN)
---

<div class="img-div-any-width" markdown="0">
    <img src="/images/mc_ocr/gcn.png"  style="width: 600px;" align="middle"/>
</div>
Vừa rồi team mình có thi cuộc thi MC_OCR và đạt top 2 cho task trích xuất thông tin từ hóa đơn.<br/><br/>
kk
<div class="img-div" markdown="0">
    <img src="/images/mc_ocr/mc_ocr_samples.jfif" />
</div>
